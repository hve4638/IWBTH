...
todo_add(motion[0], Todo.spr, spr_providience_ready10, 0, 1);
todo_add(motion[0], Todo.sleep, 10);
todo_add(motion[0], Todo.spr, spr_providience_attack10, 0, 1);
todo_add(motion[0], Todo.sleep, 30);
todo_add(motion[0], Todo.spr, spr_providience_attack11, 0, 1);
todo_add(motion[0], Todo.sleep, 15);
todo_add(motion[0], Todo.spr, spr_providience_attack10, 0, 1);
